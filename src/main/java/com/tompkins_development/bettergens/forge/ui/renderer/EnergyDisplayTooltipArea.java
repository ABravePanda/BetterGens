package com.tompkins_development.bettergens.forge.ui.renderer;
...
public class EnergyDisplayTooltipArea {
    ...
    public EnergyDisplayTooltipArea(int xMin, int yMin, int width, int height, IEnergyStorage energy)  {
